            ...
            <div className="flex items-center space-x-8">
                ...
                <div className="flex space-x-4">
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-16x16.png" alt="16x16" width={16} height={16} />
                    </div>
                    <p className="text-xs mt-1">16x16</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-32x32.png" alt="32x32" width={32} height={32} />
                    </div>
                    <p className="text-xs mt-1">32x32</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-48x48.png" alt="48x48" width={48} height={48} />
                    </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-pocket-16x16.png" alt="16x16" width={16} height={16} />
                    </div>
                    <p className="text-xs mt-1">16x16</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-pocket-32x32.png" alt="32x32" width={32} height={32} />
                    </div>
                    <p className="text-xs mt-1">32x32</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-100 p-2 rounded">
                      <Image src="/images/icons/icon-pocket-48x48.png" alt="48x48" width={48} height={48} />
                    </div>
                    <p className="text-xs mt-1">48x48</p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="bg-gray-900 text-white p-4 rounded flex items-center justify-between">
                ...
                <nav className="flex space-x-4 text-sm">
                  <a href="#" className="hover:text-gray-300">Family</a>
                  <a href="#" className="hover:text-gray-300">Tasks</a>
                  <a href="#" className="hover:text-gray-300">Piggy Bank</a>
                </nav>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex space-x-8">
                <div className="text-center">
                  <div className="bg-gray-100 p-4 rounded-2xl shadow-lg" style={{ width: '120px', height: '120px' }}>
                    <Image 
